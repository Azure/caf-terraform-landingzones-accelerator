...
enterprise_scale = {
  ...
  # Implement subscription overrides

  # TODO:
  # Compose the policies to reuse the management subscription ones from TF native
  # Allows Locations aligned with regions in launchpad
  # Change allowed locations not to be UK by default
}