...
cd caf-terraform-landingzones-starter/enterprise_scale/construction_sets/aks/corp/aks_secure_baseline/standalone/
# If opened in containter in VSCode
cd /tf/caf/enterprise_scale/construction_sets/aks/corp/aks_secure_baseline/standalone/
```
